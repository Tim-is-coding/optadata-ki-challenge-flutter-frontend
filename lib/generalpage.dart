...
class EnterNewFestAbrechnungPage extends StatefulWidget {
  const EnterNewFestAbrechnungPage({Key? key}) : super(key: key);

  @override
  State<EnterNewFestAbrechnungPage> createState() =>
      _EnterNewFestAbrechnungPageState();
}

class _EnterNewFestAbrechnungPageState
    extends State<EnterNewFestAbrechnungPage> {
  static String _title = "Bestellungen Abrechnen";
  static String _path = "Abrechnen";
  ...
  Widget build(BuildContext context) {
    return Consumer<ColorNotifire>(builder: (context, value, child) {
      return Container(
          ...
          child: LayoutBuilder(
            ...
            if (constraints.maxWidth < 600) {
              // Mobile layout
              return NotImplementedYetScreen("Gesamt Abrechnung");
            } else {
              return SizedBox(
                height: 1000,
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ComunTitle(title: _title, path: _path),
                      Row(
